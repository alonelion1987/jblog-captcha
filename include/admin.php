...
<div class='wrap'>
        ...
        <div id="tbl_setting">
            ...
            <table style="padding-right: 20px;">
                <tr>
                    ...
                    <td><strong>до 5</strong> символов</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><strong>до 4</strong> символов</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><strong>до 3</strong> символов</td>
                </tr>
            </table>
            <table>
                <tr>
    ...
    <div id="demo">
        ...
        if ($generate) {
            ?>
            <img style="padding: 68px 0;" src="<?php echo $obj_admin->plugin_url; ?>assets/img/<?php echo $generate; ?>.jpg?rnd=<?php echo md5(uniqid(rand(), true)); ?>">
        <?php
        }else{
    ...
    <div>
        ...
        <hr/>
        <ul>
            <ol> — 1. Для вызова html-формы капчи, используйте <strong>шорткод</strong>: <code>[jbcptch]</code> или
                <code>echo do_shortcode("[jbcptch]")</code>, или с проверкой <code>if(class_exists('JBlogCaptcha')){print
    ...
    <div>
        ...
        <ul>
            ...
            <ol> —3. Проделать п. 2, 3 из «Посылка через AJAX»</ol>
        </ul>
    </div>
</div>
